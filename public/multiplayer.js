...
socket.on("player update", (stuff) =>{
  if(stuff.id != playerId && !(stuff.id in players)) {
    ...
    newPlayerSkin.setAttribute("gltf-model", "https://cdn.glitch.global/756a4aaf-b43f-4a95-998c-1c3ac912e721/player_idle.glb?v=1723984484360")
    newPlayerSkin.setAttribute("scale", "200 200 200")
